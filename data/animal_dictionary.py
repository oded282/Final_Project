animals_list = ['raccoon Dog', 'citrinella', 'Sciurus niger', 'Ring-tailed lemur', 'chimpanzee', 'burmese black mountain Tortoise', 'Tauraco porphyrelophus',
               ...
               'Salmon pink bird eater tarantula', 'Spheniscus mendiculus', 'african Polecat', 'gastropod', 'sportive Lemur', 'swans', 'Nyctereutes procyonoides', 'atys',
               ...
               'Charadrius tricollaris', 'Ictonyx striatus', 'maggots', 'kelp Gull', 'native Cat', 'lepus', 'Colobus guerza', 'loaves', 'daubentonii', 'loggerhead',
               ...
               'Mara', 'human','humans', 'Tropical buckeye butterfly', 'Griffon vulture', 'brown Lemur', 'Bushpig', 'rufous', "Bennett's wallaby", 'armadillos', 'ibex', 'Recurvirostra avosetta',
               ...
               'Asian water buffalo', 'lemurs', 'Sociable weaver', 'pictus', 'american black Bear', 'Tayassu pecari',
               ...
               'trumpeter Swan', 'Merops nubicus', 'taeniopygia', 'silvestris', 'concolor', 'rock Dove', 'thoroughbreds', 'Lilac-breasted roller', 'Western patch-nosed snake',
